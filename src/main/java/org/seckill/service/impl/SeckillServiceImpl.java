...
public class SeckillServiceImpl implements SeckillService {
    ...
    //注入SeckillDao依赖,就不需要new
    @Autowired
    private SeckillDao seckillDao;
    //注入SuccessKilledDao依赖
    @Autowired
    private SuccessKilledDao successKilledDao;
    @Autowired
    private RedisDao redisDao;
    //混淆，不希望用户猜出md5加密后的
    private final String slat = "das*dqu*$#^wdy&*dy789q2yd*(Y@*(Y4e98hd189yue12890eyhIOH@*()Yr89";
